...
export default function DispatchOrders() {
  ...
  // Filter users to ONLY show those that have AT LEAST ONE address ready for delivery
  const readyUsers = users.filter(u => {
    return u.addresses.some(a => a.status === 'ready_for_delivery');
  });
    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      {loading ? (
        ...
        <div className="bg-white p-8 text-center text-gray-500 font-medium rounded-2xl border border-gray-100">
          No orders ready for delivery found for this date. Go to 'Ready For Deliver' to pack orders first.
        </div>
      ) : (
