...
export default function SubscriptionConvertedReport() {
    ...
    const fetchReport = async () => {
        ...
        setLoading(true);
        try {
            const res = await api.get(`/reports/subscriptions-converted?from=${from}&to=${to}`);
    ...
    return (
        <div className="p-6 max-w-6xl mx-auto space-y-6">
            <div className="flex flex-col md:flex-row items-center justify-between bg-white p-6 rounded-2xl shadow-sm border border-gray-100 gap-4">
                <div>
                    <h1 className="text-2xl font-bold text-gray-900 tracking-tight">Subscription Converted Report</h1>
                    <p className="text-gray-500 text-sm mt-1">Users registered within date range who eventually bought a package.</p>
                </div>
            ...
            <div className="bg-white border border-gray-100 rounded-2xl shadow-sm overflow-hidden">
                <div className="p-4 border-b border-gray-100 flex items-center justify-between">
                    ...
                    <div className="font-semibold text-emerald-700 bg-emerald-50 border border-emerald-100 px-4 py-2 rounded-xl">
