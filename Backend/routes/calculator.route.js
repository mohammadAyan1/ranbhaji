...
import { createDraft, getDrafts, deleteDraft, updateDraft } from "../controllers/calculator.controller.js";
import { requireAuth, requireRole } from "../middlewares/auth.middleware.js";

const router = express.Router();

router.post("/drafts", requireAuth, requireRole(["admin"]), createDraft);
router.put("/drafts/:id", requireAuth, requireRole(["admin"]), updateDraft);
